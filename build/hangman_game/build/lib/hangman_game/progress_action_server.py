...
class ProgressActionServer(Node):
    ...
    def __init__(self):
        ...
        # self.current_progress.game_over = False
        # self.current_progress.attempts_left = 20
    ...
    def progress_callback(self, msg):
        ...
        self.get_logger().info(f'Progress updated: {self.current_progress.current_state}')
    ...
    def execute_callback(self, goal_handle):
        ...
        while not self.current_progress.game_over:
            ...
            self.get_logger().info(f'Current State: {self.current_progress.current_state}')
            self.get_logger().info(f'Attempts Left: {self.current_progress.attempts_left}')
